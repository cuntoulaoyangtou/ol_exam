...
public interface UserMapper extends Mapper<User> {
    ...
    @Select("select * from u_user where c_id in(select c_id from u_clazz where g_id in (select g_id from u_grade where s_id = #{s_id}))")
    public List<User> getUsersBySID(Integer s_id);
